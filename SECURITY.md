...
- The tool not handling pixel-level OCR redaction: documented limitation, not a vulnerability.
- Private tags not being scrubbed: documented limitation of the Basic Profile scope.
  Institutions requiring private-tag handling should implement a custom profile.
